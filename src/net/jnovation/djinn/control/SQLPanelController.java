...
import net.jnovation.djinn.model.SQLResultSetTableModel;
import net.jnovation.djinn.ui.panels.SQLQueryPanel;

public class SQLPanelController implements ActionListener {

    private JFrame frame;
    private SQLQueryPanel panel = new SQLQueryPanel();
    private SQLResultSetTableModel tableModel;
    
    public SQLPanelController() {
