...
public interface LocationVisitor {
    ...
    /**
     * Called on each new package found.
     ...
     * @param packageQualifiedName
     * @param className
     * @param byteCodeInputStream
     */
    public void visitClass(String packageQualifiedName, String className, InputStream byteCodeInputStream);
