...
import com.fbksoft.djinn.ui.table.JavaItemTableFactory;
...
public class DependencyListPanel extends JPanel {
	...
	public DependencyListPanel() {
		...
		JLabel dependenciesLabel = new JLabel(ResourceBundle.getBundle("com.fbksoft.djinn.ui.i18n.messages").getString("DependencyDetailsPanel.lblNewLabel.text_2")); //$NON-NLS-1$ //$NON-NLS-2$
		dependenciesLabel.setFont(new Font("DejaVu Sans", Font.BOLD, 12));
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
		
		JLabel containerFilterLabel = new JLabel(ResourceBundle.getBundle("com.fbksoft.djinn.ui.i18n.messages").getString("DependencyDetailsPanel.lblFilterByContainer.text")); //$NON-NLS-1$ //$NON-NLS-2$
		containerFilterLabel.setFont(new Font("DejaVu Sans", Font.BOLD, 12));
		
		containerFilterName = new JLabel(ResourceBundle.getBundle("com.fbksoft.djinn.ui.i18n.messages").getString("DependencyDetailsPanel.lblNewLabel.text_3")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		JToggleButton groupByClassButton = new JToggleButton(ResourceBundle.getBundle("com.fbksoft.djinn.ui.i18n.messages").getString("DependencyDetailsPanel2.tglbtnNewToggleButton.text")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		JToggleButton groupByPackageButton = new JToggleButton(ResourceBundle.getBundle("com.fbksoft.djinn.ui.i18n.messages").getString("DependencyDetailsPanel2.tglbtnNewToggleButton_1.text")); //$NON-NLS-1$ //$NON-NLS-2$
		buttonGroup.add(groupByPackageButton);
		groupByPackageButton.setAction(groupByPackageAction);
		toolBar.add(groupByPackageButton);
		
		JToggleButton groupByLocationButton = new JToggleButton(ResourceBundle.getBundle("com.fbksoft.djinn.ui.i18n.messages").getString("DependencyDetailsPanel2.tglbtnNewToggleButton_2.text")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		JToggleButton groupByProjectButton = new JToggleButton(ResourceBundle.getBundle("com.fbksoft.djinn.ui.i18n.messages").getString("DependencyDetailsPanel2.tglbtnNewToggleButton.text_1")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		JToggleButton showInternalReferencesButton = new JToggleButton(ResourceBundle.getBundle("com.fbksoft.djinn.ui.i18n.messages").getString("DependencyDetailsPanel2.tglbtnNewToggleButton.text_2")); //$NON-NLS-1$ //$NON-NLS-2$
