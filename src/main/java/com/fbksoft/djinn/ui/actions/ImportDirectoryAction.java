...
import com.fbksoft.djinn.bytecode.importer.RecursiveDirectoryImporter;
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            AbstractSwingWorker worker = new AbstractSwingWorker(true) {
                ...
                public Object construct() {
                    ...
                    RecursiveDirectoryImporter importer = new RecursiveDirectoryImporter(fc.getSelectedFile());
