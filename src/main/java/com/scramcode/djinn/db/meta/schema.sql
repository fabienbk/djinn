...
CREATE TABLE LOCATIONS ( 
	...
	project_key			INTEGER 		,
	CONSTRAINT project_key_fk FOREIGN KEY ( project_key ) REFERENCES PROJECTS ( project_key ) ON DELETE CASCADE
);
...
CREATE  TABLE PACKAGES ( 
	...
	CONSTRAINT location_key_fk FOREIGN KEY ( location_key ) REFERENCES LOCATIONS ( location_key ) ON DELETE CASCADE,
	CONSTRAINT project_key_fk4 FOREIGN KEY ( project_key ) REFERENCES PROJECTS ( project_key ) ON DELETE CASCADE
);
...
CREATE  TABLE CLASSES ( 
    ...
    CONSTRAINT project_key_fk3 FOREIGN KEY ( project_key ) REFERENCES PROJECTS ( project_key ) ON DELETE CASCADE    
);
